...
$select = query("SELECT sum(total) as gt , count(invoice_id) as invoice from tbl_invoice");
confirm($select);
...
$select = query("SELECT count(product) as pname from tbl_product");
confirm($select);
...
$select = query("SELECT count(category) as cate from tbl_category");
confirm($select);
                        ...
                        <div style="overflow-x:auto;">
                            <table class="table table-striped table-hover " id="table_bestsellingproduct">
                                ...
                                <tbody>
                                    ...
                                    $select = query("SELECT product_id,product_name,rate,sum(qty) as q , sum(saleprice) as total from tbl_invoice_details group by product_id order by sum(qty) DESC LIMIT 12");
                                    confirm($select);
                        ...
                        <div style="overflow-x:auto;">
                            <table class="table table-striped table-hover " id="table_recentorder">
                                ...
                                <tbody>
                                    ...
                                    $select = query("SELECT * from tbl_invoice  order by invoice_id DESC LIMIT 30");
                                    confirm($select);

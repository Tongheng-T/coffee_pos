        ...
        <div class="card card-warning card-outline">
          ...
          <form action="" method="post" name="">
            ...
            <div class="card-body">
              ...
              <?php
              $select = query("SELECT sum(total) as grandtotal , sum(subtotal) as stotal, count(invoice_id) as invoice from tbl_invoice where order_date between '$date_1' AND '$date_2'");
              confirm($select);
              ...
              <div class="fhf" style="overflow-x:auto;">

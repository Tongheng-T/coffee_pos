...
if (isset($_POST['btnupdateorder'])) {
  ...
  $update_tbl_invoice = query("UPDATE tbl_invoice SET order_date='{$txt_orderdate}',subtotal='{$txt_subtotal}',discount='{$discountp}',discountp='{$txt_discount}',total='{$txt_total}',payment_type='{$txt_payment_type}',due='{$txt_due}',paid='{$txt_paid}',edit='{$saler_name}' where invoice_id=$id");
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="txtdiscountp" id="txtdiscount_n" readonly>
                        <div class="input-group-append">
                          <span class="input-group-text"><i class="fa" style="font-size: 24px;">៛</i></span>
                        </div>
                      </div>
